    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            checkout_session = stripe.checkout.Session.create(
                ...
                mode='payment',
                success_url=BASE_CLIENT_URL +'/it/orders/payment?success=true',
                cancel_url=BASE_CLIENT_URL + '/it/profile/orders/' + product.id,
            )
...
def stripe_webhook(request):
    ...
    try:
        ...
        payload, sig_header, settings.STRIPE_WEBHOOK_SECRET_IT
        )
