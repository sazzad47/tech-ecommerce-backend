...
from authentication.serializers import SendPasswordResetEmailSerializer, UserChangePasswordSerializer, UserLoginSerializer, UserPasswordResetSerializer, UserProfileSerializer, UserRegistrationSerializer, UserRegistrationVerifySerializer, BillingAddressSerializer, UserProfileSerializer
